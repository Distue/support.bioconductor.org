...
#PRODUCTION = socket.gethostname() in ["forum"] 
...
NAVBAR_TAGS = ["Computational", "Biology", "Chemistry", "Statistics"]

# The last categories. These tags have special meaning internally.
END_CATEGORIES = ["Fun", "Pinboard"]
...
ADMIN_LOCATION = "Heidelberg, Germany"
ADMINS = (
...
ACCOUNT_CONFIRM_EMAIL_ON_GET = False # EMBL

# LDAP Authentification
#AUTH_LDAP_SERVER_URI = "ldap://ldap.embl.org"
# For this, you want to be using the -H flag setting you used above.
#AUTH_LDAP_SERVER_URI = "ldaps://ldap.embl.org:636" 
AUTH_LDAP_SERVER_URI = "ldap://ldap.embl.org:389" 
...
# ??
AUTH_LDAP_USER_SEARCH = LDAPSearch("cn=Users,dc=embl,dc=org",
        ldap.SCOPE_SUBTREE, "(&(objectClass=emblPerson)(uid=%(user)s))")
...
MAX_POSTS_NEW_USER = 20
MAX_POSTS_TRUSTED_USER = 40

# How many top level posts per day for a new user.
MAX_TOP_POSTS_NEW_USER = 30000 # artificially inflated, change back to 2!
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = "[forum] "
